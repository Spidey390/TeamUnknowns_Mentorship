          ...
          <div className="bg-black/30 border border-white/5 p-6 rounded-xl flex flex-col justify-between">
            <div>
              <h4 className="text-white font-bold font-display text-sm uppercase tracking-wider mb-2">
                <span className="flex items-center gap-2"><BookOpen className="w-4 h-4 text-brandGold" /> Simple Definition for Students</span>
              </h4>
            ...
            <div className="bg-brandGold/5 border border-brandGold/20 p-3 rounded-lg text-[10px] text-brandGold leading-relaxed">
              {pair === 'EUR/USD' ? (
                <span className="flex items-start gap-2"><Lightbulb className="w-4 h-4 text-brandGold shrink-0 mt-0.5" /><span><strong>Why 4 Decimals?</strong> If EUR/USD moves from 1.1050 to 1.1051, that is 1 pip. A move of 5 pips is 0.0005.</span></span>
              ) : pair === 'USD/JPY' ? (
                <span className="flex items-start gap-2"><Lightbulb className="w-4 h-4 text-brandGold shrink-0 mt-0.5" /><span><strong>Yen Difference:</strong> If USD/JPY moves from 145.25 to 145.26, that is 1 pip. A move of 10 pips is 0.10 JPY.</span></span>
              ) : (
                <span className="flex items-start gap-2"><Lightbulb className="w-4 h-4 text-brandGold shrink-0 mt-0.5" /><span><strong>Gold Difference:</strong> If Gold moves from 2350.50 to 2350.60, that is 1 pip (10 cents). A $1.00 move is 10 pips.</span></span>
              )}
            </div>
          </div>
        </div>
