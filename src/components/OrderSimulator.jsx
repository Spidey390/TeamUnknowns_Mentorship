              ...
              <div className="space-y-1 block mt-2 text-[11px] font-mono">
                ...
                {qty > 100 ? (
                  <span className="text-rose-400 font-bold block mt-2">
                    <span className="flex items-center gap-1.5"><AlertTriangle className="w-4 h-4 text-amber-400 shrink-0" /> Warning: Slippage detected. Capital cost is too high!</span>
                  </span>
                ) : (
                  <span className="text-green-400 font-semibold block mt-2">
                    <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" /> Success: Instant order filled at target price.</span>
                  </span>
                )}
              </div>
            </div>
