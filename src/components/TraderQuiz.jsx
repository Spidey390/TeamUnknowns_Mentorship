import { Zap, Sun, Waves, Building2, Target } from "lucide-react";
...
export default function TraderQuiz() {
  ...
  const profiles = {
    ...
    day: {
      ...
      icon: <Sun className="w-8 h-8 text-brandGold" />,
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          <h3 className="text-2xl font-bold text-white font-display flex items-center gap-2">
            <span className="flex items-center gap-2"><Target className="w-6 h-6 text-brandGold" /> Find Your Trading Style</span>
          </h3>
