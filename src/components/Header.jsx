    ...
    <header className="fixed w-full top-0 z-50 glass-panel border-b border-brandGold/20 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-6 lg:gap-8 xl:gap-10 text-xs font-semibold tracking-widest uppercase">
          ...
          <a href="#module2" className="text-white/80 hover:text-brandGold whitespace-nowrap transition-all duration-300 relative pb-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-brandGold hover:after:w-full after:transition-all after:duration-300">2. Candlesticks</a>
          <a href="#module3" className="text-white/80 hover:text-brandGold whitespace-nowrap transition-all duration-300 relative pb-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-brandGold hover:after:w-full after:transition-all after:duration-300">3. TradingView</a>
