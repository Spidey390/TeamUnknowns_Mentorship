...
export default function LeverageMarginVisualizer() {
  ...
  if (requiredMargin > balance) {
    ...
    safetyMessage = 'HIGH RISK: Very low free margin cushion. A small price move against you will trigger a margin call!';
  }
    ...
    <div className="w-full space-y-8 animate-fadeIn">
      ...
      <div className="bg-black/50 border border-white/10 rounded-2xl p-6 sm:p-8 space-y-6">
        ...
        {requiredMargin <= balance ? (
          ...
          <div className="bg-red-500/10 border border-red-500/35 p-6 rounded-xl max-w-2xl mx-auto text-center font-mono">
            <span className="text-red-400 font-bold block text-sm mb-1 flex items-center justify-center gap-1.5"><AlertTriangle className="w-4 h-4 text-red-400" /> MARGIN OUT OF BOUNDS</span>
      ...
      <div className="grid md:grid-cols-2 gap-6 items-stretch">
        ...
        <div className="bg-black/40 border border-white/5 p-6 rounded-xl flex flex-col justify-between">
          <div>
            <h5 className="text-white font-bold text-xs uppercase tracking-wider mb-3 flex items-center gap-1.5"><Home className="w-4 h-4 text-brandGold" /> Real-Life House Analogy</h5>
