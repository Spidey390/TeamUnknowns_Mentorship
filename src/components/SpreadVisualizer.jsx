import { BarChart2, Lightbulb, GraduationCap } from "lucide-react";
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-1 bg-black/40 border border-white/5 p-4 rounded-xl flex flex-col justify-between">
          ...
          <div className="space-y-2">
            ...
            >
              <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 inline-block mr-2 align-middle"></span> Low Spread (1.5 Pips)
            </button>
            <button
            ...
            >
              <span className="w-2.5 h-2.5 rounded-full bg-yellow-500 inline-block mr-2 align-middle"></span> Medium Spread (4.0 Pips)
            </button>
            <button
            ...
            >
              <span className="w-2.5 h-2.5 rounded-full bg-rose-500 inline-block mr-2 align-middle"></span> High Spread (15.0 Pips)
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h4 className="text-white font-bold font-display text-sm uppercase tracking-wider">
              <span className="flex items-center gap-2"><BarChart2 className="w-4 h-4 text-brandGold" /> Break-Even & Entry Simulator</span>
            </h4>
        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="bg-black/50 border border-white/10 p-5 rounded-xl flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="text-[10px] text-gray-500 mt-4 leading-relaxed pl-2 italic">
              <Lightbulb className="w-4 h-4 inline mr-1.5 text-brandGold" /> Notice how at 0.0 Pips move, you are in a negative PNL of <span className="text-red-400 font-semibold">-{current.spreadPips} Pips</span>. The broker collects this immediately at entry.
            </div>
          </div>
          ...
          <div className="bg-black/40 border border-white/5 p-6 rounded-xl flex flex-col justify-between">
            <h4 className="text-white font-bold text-xs uppercase tracking-wider mb-2">
              <span className="flex items-center gap-2"><GraduationCap className="w-4 h-4 text-brandGold" /> Classroom Shop Metaphor</span>
            </h4>
