import { Compass, Wrench, Crosshair } from "lucide-react";
...
export default function TimeframeVisualizer() {
  ...
  const timeframes = {
    M1: {
      ...
      movieTitle: 'Frame-by-Frame Film Reel',
        ...
        <div className="grid md:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="bg-black/40 p-5 rounded-lg border border-white/5 flex flex-col justify-between relative">
            ...
            <div className="text-brandGold text-xs font-semibold mt-4 border-t border-white/5 pt-3 font-mono text-center">
              <span className="flex items-center justify-center gap-1.5"><Compass className="w-4 h-4 text-sky-400" /> Bias: H4 / D1 = Direction</span>
            </div>
          </div>
          ...
          <div className="bg-black/40 p-5 rounded-lg border border-white/5 flex flex-col justify-between relative">
            ...
            <div className="text-brandGold text-xs font-semibold mt-4 border-t border-white/5 pt-3 font-mono text-center">
              <span className="flex items-center justify-center gap-1.5"><Wrench className="w-4 h-4 text-brandGold" /> Pattern: H1 = Setup</span>
            </div>
          </div>
          ...
          <div className="bg-black/40 p-5 rounded-lg border border-white/5 flex flex-col justify-between relative">
            ...
            <div className="text-brandGold text-xs font-semibold mt-4 border-t border-white/5 pt-3 font-mono text-center">
              <span className="flex items-center justify-center gap-1.5"><Crosshair className="w-4 h-4 text-emerald-400" /> Execution: M15 = Entry</span>
            </div>
          </div>
