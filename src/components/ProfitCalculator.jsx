      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-black/40 border border-white/5 p-6 rounded-xl flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="mt-4 text-[10px] text-gray-500 leading-relaxed italic pl-2">
            <Lightbulb className="w-4 h-4 inline mr-1.5 text-brandGold" /> Lot sizes control how much money each pip is worth. For EUR/USD and Gold, a standard lot (1.0) means every pip is worth $10 USD. For Gold, standard contract size is 100 ounces.
          </div>
        </div>
        ...
        <div className="bg-black/30 border border-white/5 p-6 rounded-xl flex flex-col justify-between">
          <div>
            <h4 className="text-white font-bold font-display text-sm uppercase tracking-wider mb-2">
              <span className="flex items-center gap-2"><Calculator className="w-4 h-4 text-brandGold" /> How the Math Works</span>
            </h4>
          ...
          <div className="mt-4 bg-brandGold/5 p-3 rounded-lg border border-brandGold/15 text-[10px] text-brandGold leading-relaxed">
            <Lightbulb className="w-4 h-4 inline mr-1.5 text-brandGold" /> <strong>Remember:</strong> In forex and commodities, pip captures price movement, whereas Lot Size scales the contract value. Higher lot sizes yield greater rewards but carry higher risk!
          </div>
        </div>
      </div>
    </div>
