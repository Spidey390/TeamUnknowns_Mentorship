import { Lightbulb, TrendingUp, TrendingDown, User, Briefcase, Building2, Palette, Zap, Sun, Waves } from "lucide-react";
...
export default function ModuleBasics() {
  return (
    <>
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-6">
                  ...
                  <div className="bg-black/50 p-5 rounded border border-white/10">
                      ...
                      <span className="text-gray-300 font-light text-sm block leading-relaxed">
                          <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 inline-block mr-1.5 align-middle"></span> <strong className="text-white">Opens:</strong> Monday at 3:30 AM IST<br />
                          <span className="w-2.5 h-2.5 rounded-full bg-rose-500 inline-block mr-1.5 align-middle"></span> <strong className="text-white">Closes:</strong> Saturday at 3:30 AM IST<br />
                          <span className="text-xs text-gray-500 block mt-2"><Lightbulb className="w-3.5 h-3.5 inline mr-1 text-brandGold" /> Runs 24 hours a day, 5 days a week across major global sessions (Sydney, Tokyo, London, New York).</span>
                      </span>
                  </div>
                  <div className="bg-brandGold/5 p-5 rounded border border-red-500/20 col-span-1 md:col-span-3">
                      <span className="text-red-400 font-bold uppercase text-xs tracking-widest block mb-2"><Lightbulb className="w-3.5 h-3.5 inline mr-1 text-red-400" /> The Myth of the "Free Market"</span> 
      ...
      <section id="broker-section" className="min-h-screen flex flex-col items-center justify-center py-24 px-4 sm:px-6 relative z-10">
          <div className="w-full max-w-5xl flex flex-col">
              <div className="mb-10 text-center md:text-left">
                  ...
                  <h2 className="text-3xl font-black font-display uppercase tracking-wide">Brokers</h2>
              </div>
                  ...
                  <div className="space-y-8">
                      ...
                      <div className="bg-black/40 border border-white/5 p-8 rounded-xl relative overflow-hidden">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                              ...
                              <div className="text-sm font-semibold text-green-400">Target: Market goes UP <TrendingUp className="w-4 h-4 inline ml-1 text-green-400" /></div>
                          </div>
                      ...
                      <div className="bg-black/40 border border-white/5 p-8 rounded-xl relative overflow-hidden">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                              ...
                              <div className="text-sm font-semibold text-red-400">Target: Market goes DOWN <TrendingDown className="w-4 h-4 inline ml-1 text-red-400" /></div>
                          </div>
                          <div className="grid lg:grid-cols-3 gap-8 text-sm font-light leading-relaxed text-gray-300">
                              <div className="bg-black/30 p-5 rounded-lg border border-white/5">
      ...
      {/* 1.9 Types of Traders & Market Impact */}
              ...
              <div>
                      ...
                      <div className="glass-panel border-t-4 border-t-brandGold p-6 rounded-xl flex flex-col justify-between hover:scale-[1.02] transition-transform duration-300 group bg-black/40 border border-white/5">
                          <div>
                              <div className="flex justify-between items-center mb-6">
                                  ...
                                  <Briefcase className="w-6 h-6 text-brandGold" />
                              </div>
                  ...
                  <div className="glass-panel p-6 sm:p-8 rounded-xl border border-white/10 relative overflow-hidden bg-black/40 mb-6">
                      ...
                      <h4 className="text-lg font-bold font-display uppercase tracking-wider text-brandGold mb-2 flex items-center gap-2">
                          <Palette className="w-5 h-5 inline mr-2 text-brandGold" /> The "Brush" vs. "The Crowd"
                      </h4>
                      ...
                      <div className="glass-panel border-t-4 border-t-sky-400 p-6 rounded-xl flex flex-col justify-between hover:scale-[1.03] hover:shadow-lg hover:shadow-sky-400/10 transition-all duration-300 group bg-black/40 border border-white/5">
                          <div>
                              <div className="flex justify-between items-start mb-4">
                                  ...
                                  <Zap className="w-5 h-5 text-gray-500 group-hover:text-sky-400 transition-colors duration-300" />
                              </div>
                      ...
                      <div className="glass-panel border-t-4 border-t-brandGold p-6 rounded-xl flex flex-col justify-between hover:scale-[1.03] hover:shadow-lg hover:shadow-brandGold/10 transition-all duration-300 group bg-black/40 border border-white/5">
                          <div>
                              <div className="flex justify-between items-start mb-4">
                                  ...
                                  <Sun className="w-5 h-5 text-gray-500 group-hover:text-brandGold transition-colors duration-300" />
                              </div>
                      ...
                      <div className="glass-panel border-t-4 border-t-purple-400 p-6 rounded-xl flex flex-col justify-between hover:scale-[1.03] hover:shadow-lg hover:shadow-purple-400/10 transition-all duration-300 group bg-black/40 border border-white/5">
                          <div>
                              <div className="flex justify-between items-start mb-4">
                                  ...
                                  <Waves className="w-5 h-5 text-gray-500 group-hover:text-purple-400 transition-colors duration-300" />
                              </div>
                      ...
                      <div className="glass-panel border-t-4 border-t-emerald-400 p-6 rounded-xl flex flex-col justify-between hover:scale-[1.03] hover:shadow-lg hover:shadow-emerald-400/10 transition-all duration-300 group bg-black/40 border border-white/5">
                          <div>
                              <div className="flex justify-between items-start mb-4">
                                  ...
                                  <Building2 className="w-5 h-5 text-gray-500 group-hover:text-emerald-400 transition-colors duration-300" />
                              </div>
